...
export const codeToSubcategory = (code: number) => {
  const subcategory = list_of_subcategory.find((item) => item.code === code);
  return subcategory ? subcategory.name : 'every';
};
export const codeToDate = (code: number) => {
  const subcategory = list_of_subcategory.find((item) => item.code === code);
  return subcategory ? subcategory.date : 'every';
};
export const codeToDateFormated = (code: number) => {
  const subcategory = list_of_subcategory.find((item) => item.code === code);
